### Especificação de Caso de Uso: Visualizar Notificações

**1. Descrição do Caso de Uso**  
**COMO** Pessoa Responsável/Cuidador  
**QUERO** Receber notificações sobre atualizações do paciente (eventos perdidos, alertas sinais vitais, medicamentos, hábitos sem registros)
**PARA** Não perder atividades presentes na rotina do paciente
