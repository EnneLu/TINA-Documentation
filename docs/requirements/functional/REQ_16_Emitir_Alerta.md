...
**COMO** Monitorador de Sinais Vitais  
**QUERO** Emitir alertas em tempo real sobre alterações nos batimentos cardíacos durante a execução de hábitos  
**PARA** Garantir a segurança e saúde da paciente ao identificar anomalias rapidamente.  
