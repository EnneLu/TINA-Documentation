...
**COMO** Responsável  
**QUERO** Registrar, atualizar ou excluir os medicamentos da paciente  
**PARA** Organizar e garantir o acompanhamento correto da medicação diária.  

**2. Pré-condições**  
- O usuário deve estar autenticado no sistema.  
- Deve haver pelo menos uma paciente vinculada ao perfil do usuário.  

**3. Fluxo Principal**  
1. O usuário acessa a funcionalidade de gerenciamento de medicamentos no perfil da paciente.  
...
3. O usuário realiza uma das seguintes ações:  
   - **Adicionar Medicamento**:  
     ...
     3. O sistema salva o medicamento nos dados da paciente.  
   ...
   - **Excluir Medicamento**:  
     ...
     3. O usuário confirma, e o medicamento é removido dos dados da paciente.  
...
**5. Pós-condições**  
- Os medicamentos cadastrados são exibidos na rotina diária da paciente.  
...
- **RN02** - O sistema deve permitir registrar múltiplos medicamentos para a mesma paciente.  
