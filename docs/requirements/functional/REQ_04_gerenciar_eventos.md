...
**QUERO** Cadastrar eventos na agenda do paciente  
**PARA** Organizar agenda de eventos (exames, consultas) do paciente
...
2. O sistema exibe uma lista de tipos de tarefas que podem ser criadas (exame ou consultas).  
