...
**QUERO** Visualizar um Dashboard de Saúde do paciente
**PARA** Monitorar métricas de saúde, hábitos, eventos de forma visual e interativa, com o intuito de verificar evolução, perdas de desempenho nas rotinas.
