...
**COMO** Responsável  
**QUERO** Adicionar, atualizar ou remover cuidadores vinculados à paciente no qual sou responsável  
**PARA** Gerenciar a equipe de apoio e organizar os dias de acompanhamento do paciente.  

**2. Pré-condições**  
- O responsável deve estar autenticado no sistema.  
- Deve haver pelo menos uma paciente vinculada ao perfil do responsável.  

**3. Fluxo Principal**  
1. O responsável acessa a funcionalidade de gerenciamento de cuidadores.  
2. O sistema exibe a lista de cuidadores vinculados à paciente.  
3. O responsável realiza uma das seguintes ações:  
   - **Adicionar Cuidador**:  
     ...
     2. O responsável seleciona os dias da semana em que o cuidador acompanhará o paciente.  
     3. O sistema valida os dados inseridos.  
     4. O sistema vincula o cuidador ao perfil da paciente.  
   - **Atualizar Cuidador**:  
   ...
   - **Remover Cuidador**:  
     ...
     3. O responsável confirma a exclusão, e o cuidador é desvinculado do perfil da paciente.  
