### Especificação de Caso de Uso: Gerenciar Dados Paciente  

**1. Descrição do Caso de Uso**  
**COMO** Responsável  
**QUERO** Adicionar, atualizar e excluir dados pessoais e de saúde de pacientes o quais sou responsável
**PARA** Manter minhas informações sempre atualizadas.  

**2. Pré-condições**  
- O usuário deve estar autenticado no sistema como responsável e possuir um paciente cadastrado.  
...
**6. Regras de Negócio**  
- **RN01** - Somente usuários autorizados  podem modificar dados sensíveis.  
...
- Forma de acesso?  
  - Somente usuários autenticados podem acessar, adicionar ou modificar os dados. O sistema implementa controle de acesso baseado em papéis (Responsável).  
