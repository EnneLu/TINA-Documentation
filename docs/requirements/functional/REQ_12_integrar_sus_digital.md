...
**COMO** Responsável 
**QUERO** Integrar informações de saúde do paciente registradas no Meus SUS Digital  
**PARA** Garantir que os dados de saúde estejam atualizados e acessíveis em ambas as plataformas.  
